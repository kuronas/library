...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <x-app-layout>
       ...
       <h1 class="mt-2">Tambah Kategori</h1>
      ...
      <div class="my-2 w-50">
        <form action="add-buku" method="post" class="">
          ...
          <div>
            ...
            <br>
            <input type="text" name="judul" id="judul" class="form-control" placeholder="Nama buku" value="{{$buku->judul}}">
          </div>
          <div>
            <label for="penulis" class="form-label">penulis</label>
            <br>
            <input type="text" name="penulis" id="penulis" class="form-control" placeholder="Nama penulis" value="{{$buku->penulis}}">
          </div>
          <div>
            <label for="penerbit" class="form-label">penerbit</label>
            <br>
            <input type="text" name="penerbit" id="penerbit" class="form-control" placeholder="Nama penerbit" value="{{$buku->penerbit}}">
          </div>
          <div>
