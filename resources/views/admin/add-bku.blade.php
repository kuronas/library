      ...
      <div class="w-50  pb-10">
        <form action="add-buku" method="post" enctype='multipart/form-data'>
          ...
          <div>
            ...
            <br>
            <input type="text" name="judul" id="judul" class="form-control" placeholder="Nama buku">
          </div>
          <div>
          ...
          <div>
            ...
            <br>
            <input type="text" name="penerbit" id="penerbit" class="form-control" placeholder="Nama penerbit">
          </div>
          <div>
